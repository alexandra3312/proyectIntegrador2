...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C47FC9638");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F5433D807");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483025EAA5E");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1077956E883");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547ED07B4BC5");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132A8822DFE");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7647A9AEA5");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8FE02951A");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEEC764D28");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6AE07289D");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614AA73CB07");

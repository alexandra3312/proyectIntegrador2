    ...
    $(document).ready(function () {
        ...
        function formatoResultados(data) {
            ...
            var contenedor = $(
                ...
                <tr>
                <td style = "width: 60px">
                <img style="height:60pw;width:60px;margin-right:10px" src="${data.urlImagen}"/>
                </td>
                <td>
...
$("#cboBuscarProducto").on("select2:select", function (e) {
    ...
    swal({
        ...
        function (valor) {
            ...
            let producto = {
                idProductp: data.id,
                marcaProducto: data.text,
                descripcionProducto: data.text,
                categoriaPorducto: data.categoria,
                cantidad: parseInt(valor),
                precio: data.precio.toString(),
                tota: (parseFloat(valor) * data.precio).toString()
...
function mostrarProducto_Precios() {
    ...
    ProductosParaVenta.forEach((item) => {
        ...
        $("#tbProducto tbody").append(
            $("<tr>").append(
                $("<td>").append(
                    $("<button>").addClass("btn btn-danger btn-elimiar btn-sm").append(

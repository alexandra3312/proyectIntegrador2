...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        {
            List<VMCategoria> vmListaCategoria= _mapper.Map<List<VMCategoria>>(await _categoriaServicio.Lista());
            return StatusCode(StatusCodes.Status200OK, vmListaCategoria);
        }

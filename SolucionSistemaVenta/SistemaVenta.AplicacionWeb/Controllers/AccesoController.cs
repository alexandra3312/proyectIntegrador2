...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class AccesoController : Controller
    {
        ...
        public async Task< IActionResult> Login(VMUsuarioLogin modelo)
        {
            ...
            {
                ViewData["Mensaje"] = "No se ha encontrado coincidencias de usuario";
                return View();
            }
        ...
        public async Task<IActionResult> RestablecerClave(VMUsuarioLogin modelo)
        {
            try
            {
                ...
                if(resultado)
                {
                    ViewData["Mensaje"] = "Listo, su contraseña fue restablecidad. Revise su correo";
                    ViewData["MensajeError"] = null;
                }
                else
                {
                    ViewData["Mensaje"] = null;
                    ViewData["MensajeError"] = "Tenemos un inconveniente. Por favor, ingrese más tarde";
                }
            }
            catch (Exception ex)
            {

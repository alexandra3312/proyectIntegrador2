...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class VentaController : Controller
    {
        ...
        private readonly ITipoDocumentoVentaService _documentoVentaServicio;
        private readonly IVentaService _ventaServicio;
        private readonly IConverter _converter;

        public VentaController(IMapper mapper, ITipoDocumentoVentaService documentoVentaServicio, IVentaService ventaServicio, IConverter converter)
        {
            _mapper = mapper;
            _documentoVentaServicio = documentoVentaServicio;
        ...
        {
            List<VMTipoDocumentoVenta> vmListaTipoDocumentos = _mapper.Map<List<VMTipoDocumentoVenta>>(await _documentoVentaServicio.Lista());

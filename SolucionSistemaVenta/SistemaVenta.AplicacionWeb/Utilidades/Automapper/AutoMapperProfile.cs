    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Usuario, VMUsuario>()
                .ForMember(destino => destino.EsActivo, op => op.MapFrom(origen => origen.EsActivo == true ? 1 : 0))
            ...
            CreateMap<Venta, VMVenta>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.SubTotal, new CultureInfo("es-PE")))
                )
                .ForMember(destino => destino.ImpuestoTotal,
                opt => opt.MapFrom(origen => Convert.ToString(origen.ImpuestoTotal, new CultureInfo("es-PE")))
                )

    ...
    public class UsuarioService : IUsuarioService
    {
            ...
            try
            {
                ...
                if(UrlPlantillaCorreo != "")
                {
                    ...
                    if(response.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        {
                            StreamReader readerStrem = null; 

                            if(response.CharacterSet == null)
                                readerStrem = new StreamReader(dataStream);
                            else
                                readerStrem = new StreamReader(dataStream,Encoding.GetEncoding(response.CharacterSet));

                            htmlCorreo = readerStrem.ReadToEnd();
        ...
        public async Task<Usuario> Editar(Usuario entidad, Stream Foto = null, string NombreFoto = "")
        {
            ...
            try
            {
                ...
                if (!respuesta)
                    throw new TaskCanceledException("No se modifico el usuario");
        ...
        public async Task<bool> Eliminar(int IdUsuario)
        {
            try
            {
                ...
                bool respuesta = await _repositorio.Elimiar(usuario_encontrado);
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No se econtro ningun usuario asociado a ese correo");
